...
class Vector {
  ...
  add(vec, dt) {
    return vectorFactory(this.x + (vec.x || 0) * (dt || 1), this.y + (vec.y || 0) * (dt || 1));
  }
  /**
...
function TileEngine(properties = {}) {
  ...
  function render(canvas) {
    ...
    tileEngine.context.drawImage(canvas, tileEngine.sx, tileEngine.sy, width, height, 0, 0, width, height);
  }
...
image.onload = function () {
  ...
  exports.dino = dino = (0, _kontra.Sprite)({
    type: "dino",
    x: 125 + 12,
    y: 120,
    gravity: 0.75,
...
},{"kontra":"node_modules/kontra/kontra.mjs"}],"src/createGround.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createGround = void 0;

var _kontra = require("kontra");

var createGround = function createGround(ctx, x) {
...
},{"kontra":"node_modules/kontra/kontra.mjs"}],"src/createEnemy.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createEnemy = void 0;

var _kontra = require("kontra");

var createEnemy = function createEnemy(ctx) {
  var size = Math.round(Math.random() * 20 + 1);
  return (0, _kontra.Sprite)({
    type: "bullet",
    x: -size * 0.5,
    y: -size * 0.5,
...
},{"kontra":"node_modules/kontra/kontra.mjs"}],"src/createFuture.js":[function(require,module,exports) {
"use strict";
...
var createFuture = function createFuture(canvas) {
  return (0, _kontra.Sprite)({
    type: "future",
    x: canvas.width - 10,
    // starting x,y position of the sprite
...
},{"kontra":"node_modules/kontra/kontra.mjs"}],"src/createPast.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createPast = void 0;

var _kontra = require("kontra");

var createPast = function createPast(canvas) {
  return (0, _kontra.Sprite)({
    type: "past",
    x: -canvas.width + 10,
    // starting x,y position of the sprite
...
},{"kontra":"node_modules/kontra/kontra.mjs"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _createEnemy = require("./src/createEnemy");

var _createFuture = require("./src/createFuture");

var _createPast = require("./src/createPast");
...
var collideGround = function collideGround() {
  if (_createDino.dino.y >= canvas.height - _createDino.dino.height) {
    _createDino.dino.y = canvas.height - _createDino.dino.height;
    _createDino.dino.grounded = true;
    _createDino.dino.jumping = false;
    _createDino.dino.dy = 0;
  }
};
...
var loop = (0, _kontra.GameLoop)({
  update: function update(dt) {
    ...
    if (_createDino.dino.lastY - _createDino.dino.y >= 60) {
      _createDino.dino.jumping = false;
    } // Pull dino down if not jumping and in the air


    if (!_createDino.dino.grounded && !_createDino.dino.jumping) {
      _createDino.dino.dy += 0.15;

      _createDino.dino.playAnimation("jump");
    }

    if ((0, _kontra.keyPressed)("up") && _createDino.dino.grounded) {
      _createDino.dino.dy = -_createDino.dino.gravity - 2;
      _createDino.dino.grounded = false;
      _createDino.dino.jumping = true;
      _createDino.dino.lastY = _createDino.dino.y;
    ...
    if (!isMoving && !_createDino.dino.jumping) {
      _createDino.dino.playAnimation("idle");
    }

    enemies.map(function (enemy) {
      enemy.update(); // enemy is beyond the left edge
    ...
    grounds.map(function (ground) {
      return ground.update();
    });

    _createDino.dino.update();

    future.update();
    past.update();

    if (future.x - _createDino.dino.x - _createDino.dino.width + 5 < 1) {
      _createDino.dino.ttl = 0;

      _createDino.dino.playAnimation("cry");

      loop.stop();
    }

    if (past.width + past.x - _createDino.dino.x - _createDino.dino.width + 20 >= 0) {
      _createDino.dino.ttl = 0;
...
//# sourceMappingURL=/back-in-dino.e31bb0bc.js.map